...
--
-- Host: 127.0.0.1
-- Generation Time: 05 Mei 2018 pada 23.42
...
INSERT INTO `pendaftar` (`nik`, `nama`, `tempat_lahir`, `tanggal_lahir`, `asal_sekolah`, `jenis_kelamin`, `agama`, `no_seluler`, `tlp_rumah`, `email`, `alamat`, `pilihan1`, `pilihan2`, `pilihan3`) VALUES
('092375817589107', 'sadfjasf asfkasf', 'sadfjak ', '1998-09-03', 'skdaksdf alskdfjaoije fksaljf', 'l', 'budha', '903748239420385', '029834280936', 'sajfa@khgurhgk.com', 'kashfopijpoij ghauhfd', 93, 140, 120),
('15154141423', 'asfa a wqerar', 'asfasdf ewr', '2018-05-17', 'asf asf e efafa', 'l', 'katolik', '34226524624', '264262622', 'asdfa@asdaf.ghj', 'asdfew wqer qr qwr qw r ', 159, 161, 160),
('34515415154', 'sdfa asf a asdf ', 'af asfd a ', '1997-05-01', 'safasdfas', 'l', 'islam', '023151515', '01399138911', 'asdfasf@alkaf.com', 'asdfafas asfas saf asf a', 75, 40, 99),
('3462623', 'Syakir Ali', 'Bangkalan', '2018-05-09', 'asdfasdf', 'l', 'islam', '351215525', '1253125125', 'admin@admin.com', 'Jl. Raya Ketengan No. 69 - Burneh', 162, 99, 75),
('afa asdfkjafj', 'asdflka asdflkjasd adsfkl', 'asdfasdf', '1999-12-31', 'jklasjfasdf ', 'p', 'katolik', '23642624345', '9023472879283', 'asfas@askjfa', 'sadadfa asfda sdf ', 75, 159, 99),
('jlkj;lj oijjaskjhha', 'klj;joiasdf asdlkfjoij', 'aj;lkjoi fkjaj', '2015-12-31', 'kjoijiuj ajijafnjkhahf', 'p', 'katolik', '830728952389471', '90378235892', 'asfkjh@kljhsajgh.co', 'ksjfla asklfja;lkf', 99, 159, 148);
...
('admin@admin.com', 'adminadmin', '4c19d17d9ef5c26a3bf91831e03df125');
